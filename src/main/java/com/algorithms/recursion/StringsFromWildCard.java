...
public class StringsFromWildCard {
    ...
    static String[] find_all_possibilities(String s) {
        ...
        findAllPossibleStrings(s, possibleStrings);
    ...
    static void findAllPossibleStrings(String s, List<String> possibleStrings) {
        int indexOfWildCard = s.indexOf('?');
        if (indexOfWildCard < 0){
            possibleStrings.add(s);
        }else {
            String s1 = s.substring(0,indexOfWildCard) + "0" + s.substring(indexOfWildCard+1);
            String s2 = s.substring(0,indexOfWildCard) + "1" + s.substring(indexOfWildCard+1);
            findAllPossibleStrings(s1, possibleStrings);
            findAllPossibleStrings(s2, possibleStrings);
        }
    }

    public static void main(String[] args){
        String s1 = "1?10";
        System.out.println(Arrays.toString(find_all_possibilities(s1)));
        String s2 = "1?0?";
        System.out.println(Arrays.toString(find_all_possibilities(s2)));
    }
}
