package com.algorithms.interviews.google.strings;
 ...
 *
 * TODO: COMPLETE after watching the below VIDEO
 * https://www.youtube.com/watch?v=PIeiiceWe_w&t=1827s
 */
public class AhoCorasick {
    ...
    static void solve(char[] phoneLetters, char[][] wordLetters){
        ...
        for(int i=0; i < words.length; i++)
            endAt[i] = trie.addWord(words[i], 0);
