package com.algorithms.interviews.fb.sorting;

import java.util.Arrays;

/**
 * Given an array of numbers, determine if you can split them into two groups of equal sum with no common elements in them.
 */
