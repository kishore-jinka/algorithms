package com.algorithms.interviews.fb.linkedlists;
...
public class ReverseOperations {
    ...
    private void reverse(Node hare, Node tortoise){
    ...
    Node reverse(Node head) {
        ...
        boolean foundSequenceEnd = false;
        while(hare != null){
            if(hare.data%2 == 0){
                ...
                if(hare.next == null || hare.next.data%2 == 1){
                    foundSequenceEnd = true;
                }
            }
            if(foundSequenceEnd && foundSequenceStart){
                if(hare.data != tortoise.data) reverse(hare, tortoise);
                foundSequenceStart = false;
                foundSequenceEnd = false;
            }
        }
        return head;
    }
